#
#  Be sure to run `pod spec lint SimpleFrameworkObjc.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "J-Rojas" => "jrojas@redlinesolutions.co" }
  # Or just: s.author    = "J-Rojas"
  # s.authors            = { "J-Rojas" => "jrojas@redlinesolutions.co" }
  ...
  s.source_files  = "SimpleFramework/*.{h,m}"
